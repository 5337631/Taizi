...
sealed class NavItem(val route: String, val titleResId: Int, val icon: ImageVector) {
        ...
        object WorkSpace :
                NavItem("work_space", R.string.nav_work_space, Icons.Default.Work)
        object PersonalSpace :
                NavItem("personal_space", R.string.nav_personal_space, Icons.Default.Person)
}
