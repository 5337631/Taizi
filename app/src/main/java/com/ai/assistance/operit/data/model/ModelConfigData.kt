...
object ModelConfigDefaults {
        ...
        /** contextLength 来源：auto_api / auto_name / manual */
        const val DEFAULT_CONTEXT_LENGTH_SOURCE = "auto_name"
}
...
data class ModelConfigData(
        ...
        val contextLengthSource: String = ModelConfigDefaults.DEFAULT_CONTEXT_LENGTH_SOURCE,
